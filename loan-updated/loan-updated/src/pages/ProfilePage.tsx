      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-1 space-y-6">
          <Card className="bg-dark-900 border-white/5 p-6 flex flex-col items-center text-center">
            <div className="w-24 h-24 rounded-2xl bg-gradient-to-tr from-brand-500 to-blue-500 mb-4 p-1">
            ...
            <h2 className="text-xl font-bold text-white mb-1">Ravi Sharma</h2>
            <p className="text-sm text-dark-400 mb-4">Founder & CEO</p>
        ...
        <div className="md:col-span-2 space-y-6">
          <Card className="bg-dark-900 border-white/5 p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2 col-span-2 md:col-span-1">
                ...
                <Input defaultValue="Ravi Sharma" className="bg-dark-800 border-white/5 h-12" />
              </div>
              <div className="space-y-2 col-span-2 md:col-span-1">
                <label className="text-xs font-bold uppercase tracking-wider text-dark-400">Date of Birth</label>
                <Input defaultValue="14/08/1985" className="bg-dark-800 border-white/5 h-12" />
              </div>
              <div className="space-y-2 col-span-2 md:col-span-1">
                ...
                <div className="relative">
                  ...
                  <Input defaultValue={user?.email || "ravi@neofi.in"} className="bg-dark-800 border-white/5 h-12 pl-10" />
                </div>
              </div>
              <div className="space-y-2 col-span-2 md:col-span-1">
                ...
                <div className="relative">
                  ...
                  <Input defaultValue="+91 98765 43210" className="bg-dark-800 border-white/5 h-12 pl-10" />
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-dark-900 border-white/5 p-6 space-y-6">
            ...
            <div className="bg-dark-800 border border-white/5 rounded-xl p-4 flex justify-between items-center">
              <div>
                <p className="text-brand-400 font-bold mb-1">NeoFi Innovations Pvt Ltd</p>
                <p className="text-xs text-dark-400">GSTIN: 27AACCN1234E1Z5</p>
              </div>
