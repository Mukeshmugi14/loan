...
import { Home, Lightbulb, FileText, Settings, UserCircle, LogOut } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-dark-950 flex flex-col md:flex-row">
      ...
      <aside className="hidden md:flex w-64 flex-col border-r border-dark-800/50 bg-dark-900/50 backdrop-blur-xl">
        ...
        <nav className="flex-1 px-4 py-6 space-y-1">
          {NAV_ITEMS.map((item) => (
            <NavLink
              ...
              to={item.path}
              className={({ isActive }) => 
                `flex items-center gap-3 px-3 py-3 rounded-xl transition-colors font-medium border ${
                  isActive 
        ...
        <div className="p-4 mb-4 mx-4 bg-gradient-to-br from-dark-800 to-dark-900 rounded-2xl border border-dark-700/50">
          <p className="text-xs text-dark-400 mb-1">Account Security</p>
          <p className="text-sm text-white font-medium">Tier 1 Verified</p>
